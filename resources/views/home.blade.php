...
<body>
    ...
    @if($errors->any())
        <div class="container">
            <div class="row">
                <div class="alert alert-danger text-center mt-3">Por favor selecione pelo menos uma operação. As parcelas devem ser números entre 0 e 999. O número de exercícios deve variar entre 5 e 50.</div>
            </div>
        </div>
    @endif
